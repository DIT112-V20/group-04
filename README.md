...
[![IMAGE ALT TEXT](https://raw.githubusercontent.com/DIT112-V20/group-04/master/misc/healthrover_yt_img.png)](https://www.youtube.com/watch?v=CxYm5EA1l_8 "HealthRover - Contactless delivery project")
...
- If the car goes offline and the user navigates back to the car selection page the list doesn't get updated and still contains the disconnected car name
